export const QUIRKS = [
  ...
  'He/she is always seen chewing gum',
  'He/she is always carrying a book, or multiple',
  ...
  'Obsession with a period in history (1900s, 1800s, Victorian Era, Renaissance, etc.)',
  ...
  'Acts dumb to attract men/women',
  ...
  'Cross dresses as man/woman for fun',
  ...
  'A woman who wears mens\ perfume, vice versa',
  'A man who sits like a woman, crossing his legs ',
  ...
  'Fangirl/boy over an anime, a band, a TV show, a video game, etc.)',
  ...
  'Has a catchphrase (that\'s what she said, oh my god, say what?, etc.)',
  ...
  'Can correctly estimate a woman\s bra size',
  ...
  'Takes deceased husband, wife, friend, etc. to their favorite restaurant on a "date"',
  ...
  'Only attracted to married men/women',
  ...
  'Child activist',
  'Tells everyone they have killed a man with their thumb',
  ...
  'A grown man who plays with dolls',
  ...
  'Types in all CAPS ',
  'Know it all',
  'Lives in a  large, metropolitan city, uses a horse as transportation',
  ...
  'Successfully picks up men/women with corny pickup lines.',
  ...
  'Never seen snow',
  'Survived a natural disaster (hurricane, earthquake, flood, etc.)',
  'Adopted',
  ...
  'Tells everyone they are YouTube famous; has 40 (or less)  subscribers',
  ...
  'A man/woman who catfishes over the internet',
  ...
  'Can speak any and every language known to man',
  ...
  'Takes pictures of good looking men/women in public',
